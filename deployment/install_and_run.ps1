...
# Build the image dynamically inside WSL from the current repository source
wsl -u root bash -c "docker build -t iosxe-upgrade-manager:local -f deployment/Dockerfile ."
